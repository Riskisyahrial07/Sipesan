...
// LIHAT TRANSAKSI
$route['lihat_transaksi'] = 'user/dataKeranjang';
...
// COPY DATA
$route['Copy_Data_View'] = 'user/copyData';


// PERUBAHAN MODAL
$route['perubahan_modal'] = 'user/PerubahanModal';
$route['perubahan_modal/detail'] = 'user/PerubahanModalDetail';

// LABA RUGI
$route['laba_rugi'] = 'user/labaRugi';
$route['laba_rugi/detail'] = 'user/labaRugiDetail';
...
//Ambil transaksi
$route['ambil_transaksi'] = 'user/Ambiltransaksi';


$route['404_override'] = '';
$route['translate_uri_dashes'] = FALSE;

$route['HomeController'] = '../HomeController';