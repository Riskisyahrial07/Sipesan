...
<head>
  ...
  <title>ACCOUNTING | <?= $titleTag ?></title>
  <!-- Favicon -->
  <link href="<?= base_url('assets/img/brand/VCA.png') ?>" rel="icon" type="image/png">
  <!-- Fonts -->
...
<nav class="navbar navbar-vertical fixed-left navbar-expand-md navbar-light bg-white" id="sidenav-main">
    <div class="container-fluid">
      ...
      <!-- <a class="navbar-brand pt-0" href="./index.html"> -->
        <img src="<?= base_url('assets/img/brand/VCA.png') ?>" class="navbar-brand-img" alt="...">
      </a>
      <!-- User -->
      ...
      <div class="collapse navbar-collapse" id="sidenav-collapse-main">
        ...
        <div class="navbar-collapse-header d-md-none">
          <div class="row">
            <div class="col-6 collapse-brand">
              <!-- <a href="./index.html"> -->
                <img src="<?= base_url('assets/img/brand/VCA.png') ?>">
              </a>
            </div>
        ...
        <ul class="navbar-nav">
          ...
          <!-- <li class="nav-item">
            <a class="nav-link" href="<?= base_url('lihat_transaksi') ?>">
              <i class="ni ni-tv-2 text-primary"></i> Lihat Transaksi
            </a>
          </li> -->
          <!-- <li class="nav-item">
            <a class="nav-link" href="<?= base_url('Copy_Data_View') ?>">
              <i class="ni ni-tv-2 text-primary"></i> Copy Data
            </a>
          </li> -->
          <li class="nav-item">
          ...
          <li class="nav-item">
            <a class="nav-link" href="<?= base_url('laba_rugi') ?>">
            <i class="ni ni-book-bookmark text-yellow"></i> Laba Rugi
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="<?= base_url('perubahan_modal') ?>">
            <i class="ni ni-book-bookmark text-yellow"></i> Perubahan Modal
            </a>
          </li>
          <li class="nav-item">
