        ...
        <div class="col mb-5 mb-xl-0">
          <div class="card shadow">
            <div class="card-header border-0">
              ...
              <div class="row">
                <div class="col my-3">
                  <form action="<?= base_url('buku_besar/detail') ?>" method="post" class="d-flex flex-row justify-content-center">
              ...
              <table class="table align-items-center table-flush">
                ...
                <?php
                  ...
                  <tr>
                    ...
                    <td scope="col">
                        <?= form_open('buku_besar/detail','',['bulan'=>$bulan,'tahun'=>$tahun]) ?>
                        <?= form_button(['type'=>'submit','content'=>'Lihat Buku Besar','class'=>'btn btn-success mr-3']) ?>
                        <?= form_close() ?>
                    </td>
                  </tr>
                  <?php
