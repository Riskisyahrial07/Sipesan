...
<div class="main-content">
    ...
    <nav class="navbar navbar-top navbar-expand-md navbar-dark" id="navbar-main">
      <div class="container-fluid">
        <!-- Brand -->
        <p class="h4 mb-0 text-white text-uppercase d-none d-lg-inline-block" href="./index.html">Laba Rugi</p>
        <!-- Form -->
              ...
              <table class="table align-items-center table-flush">
                ...
                <?php
                  ...
                  <tr>
                    ...
                    <td scope="col">
                        <?= form_open('laba_rugi/detail','',['bulan'=>$bulan,'tahun'=>$tahun]) ?>
                        <?= form_button(['type'=>'submit','content'=>'Lihat Laba Rugi','class'=>'btn btn-success mr-3']) ?>
                        <?= form_close() ?>
                    </td>
                  </tr>
                  <?php
