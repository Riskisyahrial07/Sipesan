          ...
          <div class="card shadow">
            <div class="card-header border-0">
              <div class="row align-items-center">
                <div class="col">
                  <h3 class="mb-0">Perubahan Modal</h3>
                </div>
              </div>
              <div class="row">
                <div class="col my-3">
                  <form action="<?= base_url('perubahan_modal/detail') ?>" method="post" class="d-flex flex-row justify-content-center">
              ...
              <table class="table align-items-center table-flush">
                ...
                <?php
                  ...
                  <tr>
                    ...
                    <td scope="col">
                        <?= form_open('perubahan_modal/detail','',['bulan'=>$bulan,'tahun'=>$tahun]) ?>
                        <?= form_button(['type'=>'submit','content'=>'Lihat Perubahan Modal','class'=>'btn btn-success mr-3']) ?>
                        <?= form_close() ?>
                    </td>
                  </tr>
                  <?php
