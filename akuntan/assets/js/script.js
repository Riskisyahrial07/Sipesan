$(document).ready(function () {
	...
	$('#jenis_saldo').on('change', function () {
		if($(this).val() == 'kredit') {
			$('#jenis_saldo_second').val('debit')
		} else {
			$('#jenis_saldo_second').val('kredit')
		}
	})

	$('#saldo').on('keyup', function () {
		$('#saldo_second').val($(this).val());
	})
	...
	$('#no_reff_second').change(function () {
		let nilai = $(this).val();
		$('#reff_second').val(nilai);
	});
