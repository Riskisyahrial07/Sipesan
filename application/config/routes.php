...
$route['desain'] = 'PesanController/pesanDesain';
$route['pesan'] = 'PesanController/pesanan';
$route['get-form-pesanan'] = 'PesanController/renderForm';
...
$route['hapus/desain/(:any)'] = 'PesanController/hapusDesain/$1';
...
$route['admin/bahan'] = 'backend/BahanController';
$route['admin/bahan/tambah-bahan'] = 'backend/BahanController/add';
$route['admin/bahan/store-bahan'] = 'backend/BahanController/store';
$route['admin/bahan/edit-bahan/(:any)'] = 'backend/BahanController/edit/$1';
$route['admin/bahan/update-bahan/(:any)'] = 'backend/BahanController/update/$1';
$route['admin/bahan/hapus-bahan/(:any)'] = 'backend/BahanController/delete/$1';

$route['admin/ukuran'] = 'backend/UkuranController';
$route['admin/ukuran/tambah-ukuran'] = 'backend/UkuranController/add';
$route['admin/ukuran/store-ukuran'] = 'backend/UkuranController/store';
$route['admin/ukuran/edit-ukuran/(:any)'] = 'backend/UkuranController/edit/$1';
$route['admin/ukuran/update-ukuran/(:any)'] = 'backend/UkuranController/update/$1';
$route['admin/ukuran/hapus-ukuran/(:any)'] = 'backend/UkuranController/delete/$1';

$route['admin/laporan/(:any)'] = 'backend/LaporanController/index/$1';

$route['admin/filter-chart'] = 'backend/LaporanController/filterChart';
