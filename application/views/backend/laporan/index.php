	...
	<div class="card">
		<div class="card-body">
			...
			<div class="row">
				<div class="col-md-6">
					<div class="form-group row">
						<label for="nomorSurat" class="col-sm-2 col-form-label">Tanggal Mulai</label>
						<div class="col-sm-10">
							<input type="date" class="form-control" id="tanggalMulai" autocomplete="off">
						</div>
					</div>
				</div>
				<div class="col-md-6">
					<div class="form-group row">
						<label for="nomorSurat" class="col-sm-2 col-form-label">Tanggal Akhir</label>
						<div class="col-sm-10">
							<input type="date" class="form-control" id="tanggalAkhir" autocomplete="off">
						</div>
					</div>
				</div>
				<div class="col-md-12">
					<button type="button" id="filter-chart" class="btn btn-primary" data-jenis="<?= $tipe ?>" disabled>Filter Chart</button>
				</div>
			</div>
