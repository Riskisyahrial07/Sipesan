...
<head>
	...
	<title>Visual Creative Agency</title>
	<!-- plugins:css -->
		...
		<div class="row row-offcanvas row-offcanvas-right">
			...
			<nav class="sidebar sidebar-offcanvas d-print-none" id="sidebar">
				<ul class="nav">
					...
					<li class="nav-item">
						<a class="nav-link" href="<?=base_url('admin/ukuran')?>">
							<i class="fa fa-envelope-open-o menu-icon"></i>
							<span class="menu-title">Data Ukuran</span>
						</a>
					</li>
					<li class="nav-item">
						...
						<div class="collapse" id="ui-basic">
							<ul class="nav flex-column sub-menu">
								...
								<li class="nav-item"> <a class="nav-link" href="<?=base_url('admin/laporan/kartu_nama')?>">Kartu Nama</a></li>
								<li class="nav-item"> <a class="nav-link" href="<?=base_url('admin/laporan/brosur')?>">Brosur</a></li>
								<li class="nav-item"> <a class="nav-link" href="<?=base_url('admin/laporan/desain')?>">Desain</a></li>
							</ul>
						</div>
					</li>
				</ul>
