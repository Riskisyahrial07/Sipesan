				...
				<div class="row" data-gutter="60">
					<div class="col-md-6">
						...
						<?=form_open('login')?>
							...
							<div class="form-group form-pass">
								...
								<input class="form-control" type="password" id="password_page" name="password" required autocomplete="off"/>
							</div>
							<div class="checkbox show-pass">
								<label>
									<input type="checkbox" onclick="showPassword('password_page')"> Show Password
								</label>
							</div>
					...
					<div class="col-md-6">
						...
						<?=form_open('register')?>
							...
							<div class="form-group">
								<label>Password</label>
								<input class="form-control" type="password" id="password_regis_page" required name="password" autocomplete="off"/>
							</div>
							<div class="checkbox show-pass">
								<label>
									<input type="checkbox" onclick="showPassword('password_regis_page')"> Show Password
								</label>
							</div>
							<div class="form-group">
								<label>Password Konfirmasi</label>
								<input class="form-control" type="password" id="password_konfir_page" required name="confirm_password" autocomplete="off"/>
							</div>
							<div class="checkbox show-pass">
								<label>
									<input type="checkbox" onclick="showPassword('password_konfir_page')"> Show Password
								</label>
							</div>
