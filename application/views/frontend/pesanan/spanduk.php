				...
				<div class="col-md-8">
					<div class="box">
						<div class="form-group">
							...
							<div class="row">
								<div class="col-md-6">
									<input type="text" class="form-control" id="panjang" name="panjang" onkeyup="showTotalSpanduk()"
										   placeholder="Panjang" required autocomplete="off">
								</div>
								<div class="col-md-6">
									<input type="text" class="form-control" id="lebar" name="lebar" onkeyup="showTotalSpanduk()"
						...
						<div class="form-group">
							<label for=""><span style="color: red">*</span>Keterangan :</label>
							<ul>
								<li>Biasa : Rp. 30.000 per meter</li>
								<li>Bagus : Rp. 40.000 per meter</li>
							</ul>
						</div>
					</div>
				</div>
