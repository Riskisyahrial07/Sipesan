				...
				<div class="col-md-8">
					<div class="box">
						<div class="form-group">
							...
							<div class="row">
								<div class="col-md-6">
									<input type="text" class="form-control" id="panjang" name="panjang" onkeyup="showTotalStiker()"
										   placeholder="Panjang" required autocomplete="off">
								</div>
								<div class="col-md-6">
									<input type="text" class="form-control" id="lebar" name="lebar" onkeyup="showTotalStiker()"
						...
						<div class="form-group">
							...
							<ul>
								<li>Biasa : Rp. 15.000 </li>
								<li>Bagus : Rp. 35.000</li>
							</ul>
						</div>
					</div>
				</div>
