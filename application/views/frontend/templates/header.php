...
<div class="global-wrapper clearfix" id="global-wrapper">
	...
	<div class="mfp-with-anim mfp-hide mfp-dialog clearfix" id="nav-login-dialog">
		<h3 class="widget-title">Anggota Masuk</h3>
		<p>Selamat Datang, kawan. Masuk untuk Memulai</p>
		<hr/>
		<?= form_open('login') ?>
	...
	<div class="mfp-with-anim mfp-hide mfp-dialog clearfix" id="nav-account-dialog">
		...
		<div class="form-group">
			<label>Password</label>
			<input class="form-control" type="password" id="password_regis" required name="password" autocomplete="off"/>
		</div>
		<div class="checkbox show-pass">
			<label>
				<input type="checkbox" onclick="showPassword('password_regis')"> Show Password
			</label>
		</div>
		<div class="form-group">
			<label>Password Konfirmasi</label>
			<input class="form-control" type="password" id="password_konfir" required name="confirm_password" autocomplete="off"/>
		</div>
		<div class="checkbox show-pass">
			<label>
				<input type="checkbox" onclick="showPassword('password_konfir')"> Show Password
			</label>
		</div>
		...
		<div class="container">
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="<?= base_url('') ?>">
					<p style="color: white;"><i class="fa fa-print"></i>Visual Creative Agency</p></a>
			</div>
			<div class="collapse navbar-collapse" id="main-nav-collapse">
				<ul class="nav navbar-nav">
					<li class="dropdown"><a href="<?= base_url('pesan') ?>"><i class="fa fa-reorder"></i>&nbsp; Pesan Sekarang<i
						...
						<!-- <ul class="dropdown-menu dropdown-menu-category">
							...
							<li><a href="<?= base_url('desain') ?>"><i class="fa fa-photo dropdown-menu-category-icon"></i>Desain</a>
							</li>
						</ul> -->
					</li>
				</ul>
				...
				<ul class="nav navbar-nav navbar-right">
					<?php if ($this->session->userdata('session_level') == null): ?>
						<li><a href="<?=base_url('akuntan/login')?>">Login Akuntan</a></li>
